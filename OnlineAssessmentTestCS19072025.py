"""Question: You are given two arrays A and B of N strings each, and an array C of N positive integers. They describe N monthly expenses (numbered from 0 to N-1) set up on an account. The K-th expense charges the account with an amount C[K] at the end of each month, starting from month A[K] and ending in month B[K] (inclusive). The format of each string is "MM-YYYY" (where MM denotes month, between 01 and 12, and YYYY denotes year, between 1900 and 2100), for example: "06-2021". What is the minimum monthly income needed for all of these charges to be paid? We cannot go into debt. In other words, the amount of money that remains in the account at the end of each month (after all the payments) should not drop below 0. The monthly income starts in the earliest month given in array A. The income is transfered onto the account at the beginning of the month, i.e. income for a given month is always on the account before any of the charges are payed. The balance that remains in the Write a function: def solution (A, B, C) that, given arrays A and B consisting of N strings each and an array C consisting of N positive integers, representing the expenses as described above, returns the minimum monthly income needed to cover all of the expenses. Examples: 1. Given A = ["03-2021", "04-2021", "05- 2021], B = ["03-2021", "05-2021", "05- 2021"], and C = [20, 10, 15], the function should return 20. The total expenses are: 20 (in March), 10 (in April) and 25 (in May). Starting with income 20 (in March), the total balance at the end of each month will be: 0 (in March), 10 (in April), and 5 (in May) write simple biggner friendly solution"""
"""Solution: """
